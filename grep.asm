...
000001f0 <grep>:
{
 ...
 21d:	50                   	push   %eax
 21e:	8d 81 a0 0b 00 00    	lea    0xba0(%ecx),%eax
 224:	50                   	push   %eax
 ...
 23b:	8b 4d e0             	mov    -0x20(%ebp),%ecx
    buf[m] = '\0';
 23e:	bf a0 0b 00 00       	mov    $0xba0,%edi
 243:	89 de                	mov    %ebx,%esi
 245:	c6 81 a0 0b 00 00 00 	movb   $0x0,0xba0(%ecx)
    while((q = strchr(p, '\n')) != 0){
 ...
 2f2:	81 ff a0 0b 00 00    	cmp    $0xba0,%edi
 ...
 307:	83 ec 04             	sub    $0x4,%esp
      m -= p - buf;
 30a:	2d a0 0b 00 00       	sub    $0xba0,%eax
 30f:	29 45 e0             	sub    %eax,-0x20(%ebp)
 312:	8b 4d e0             	mov    -0x20(%ebp),%ecx
      memmove(buf, p, m);
 315:	51                   	push   %ecx
 316:	57                   	push   %edi
 317:	68 a0 0b 00 00       	push   $0xba0
...
free(void *ap)
{
 ...
 961:	a1 a0 0f 00 00       	mov    0xfa0,%eax
{
 ...
 9a9:	5b                   	pop    %ebx
  freep = p;
 9aa:	89 15 a0 0f 00 00    	mov    %edx,0xfa0
}
 9b0:	5e                   	pop    %esi
 9b1:	5f                   	pop    %edi
 9b2:	5d                   	pop    %ebp
 ...
 9e7:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 9ea:	89 15 a0 0f 00 00    	mov    %edx,0xfa0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 a09:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 a0c:	8b 15 a0 0f 00 00    	mov    0xfa0,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 a4b:	39 05 a0 0f 00 00    	cmp    %eax,0xfa0
 ...
 a6e:	e8 ed fe ff ff       	call   960 <free>
  return freep;
 a73:	8b 15 a0 0f 00 00    	mov    0xfa0,%edx
 ...
 a9c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 a9f:	89 15 a0 0f 00 00    	mov    %edx,0xfa0
}
 ...
 aaf:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 ab0:	c7 05 a0 0f 00 00 a4 	movl   $0xfa4,0xfa0
 ab7:	0f 00 00 
    base.s.size = 0;
 aba:	b8 a4 0f 00 00       	mov    $0xfa4,%eax
    base.s.ptr = freep = prevp = &base;
 abf:	c7 05 a4 0f 00 00 a4 	movl   $0xfa4,0xfa4
 ac6:	0f 00 00 
    base.s.size = 0;
 ac9:	c7 05 a8 0f 00 00 00 	movl   $0x0,0xfa8
 ad0:	00 00 00 
    if(p->s.size >= nunits){
