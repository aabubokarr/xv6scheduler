 ...
 641:	a1 44 08 00 00       	mov    0x844,%eax
{
 ...
 6c7:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6ca:	89 15 44 08 00 00    	mov    %edx,0x844
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 72b:	39 05 44 08 00 00    	cmp    %eax,0x844
 ...
 74e:	e8 ed fe ff ff       	call   640 <free>
  return freep;
 753:	8b 15 44 08 00 00    	mov    0x844,%edx
 ...
 77c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 77f:	89 15 44 08 00 00    	mov    %edx,0x844
}
 ...
 78f:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 790:	c7 05 44 08 00 00 48 	movl   $0x848,0x844
 797:	08 00 00 
    base.s.size = 0;
 79a:	b8 48 08 00 00       	mov    $0x848,%eax
    base.s.ptr = freep = prevp = &base;
 79f:	c7 05 48 08 00 00 48 	movl   $0x848,0x848
 7a6:	08 00 00 
    base.s.size = 0;
 7a9:	c7 05 4c 08 00 00 00 	movl   $0x0,0x84c
 7b0:	00 00 00 
    if(p->s.size >= nunits){
