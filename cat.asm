 ...
 6e1:	a1 20 0b 00 00       	mov    0xb20,%eax
{
 ...
 729:	5b                   	pop    %ebx
  freep = p;
 72a:	89 15 20 0b 00 00    	mov    %edx,0xb20
}
 730:	5e                   	pop    %esi
 731:	5f                   	pop    %edi
 732:	5d                   	pop    %ebp
 ...
 767:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 76a:	89 15 20 0b 00 00    	mov    %edx,0xb20
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 789:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 78c:	8b 15 20 0b 00 00    	mov    0xb20,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7cb:	39 05 20 0b 00 00    	cmp    %eax,0xb20
 ...
 7ee:	e8 ed fe ff ff       	call   6e0 <free>
  return freep;
 7f3:	8b 15 20 0b 00 00    	mov    0xb20,%edx
 ...
 837:	0b 00 00 
    base.s.size = 0;
 83a:	b8 24 0b 00 00       	mov    $0xb24,%eax
    base.s.ptr = freep = prevp = &base;
 83f:	c7 05 24 0b 00 00 24 	movl   $0xb24,0xb24
 846:	0b 00 00 
    base.s.size = 0;
 849:	c7 05 28 0b 00 00 00 	movl   $0x0,0xb28
 850:	00 00 00 
    if(p->s.size >= nunits){
